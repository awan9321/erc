<header class="main-header">
    ...
    <a href="<?=templates()?>index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SIP</b>KLIM</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <img src="<?=assets()?>/logobmkg.png" class="bmkg" alt="Logo BMKG">
      <span class="navbar-brand"> <b>SISTEM INVENTARISASI PERALATAN</b> IKLIM</span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">SOPI BMKG</span>
            </a>
